Qualtrics.SurveyEngine.addOnload(function(){
    ...
    var requiredResources = [
        "https://unpkg.com/jspsych@7.1.2",
        "https://unpkg.com/@jspsych/plugin-html-keyboard-response@1.1.0",
        "https://unpkg.com/@jspsych/plugin-html-slider-response@1.1.0",
        "https://unpkg.com/@jspsych/plugin-canvas-keyboard-response@1.1.0",
        "https://unpkg.com/@jspsych/plugin-fullscreen@1.1.0",
        "https://unpkg.com/@jspsych/plugin-instructions@1.1.0",
        "https://unpkg.com/@jspsych/plugin-resize@1.0.0",
    ];
    ...
    var sbj_id = Math.floor(Math.random()*(100000-10000))+99999;
        ...
        function save_data_json(dataset, data_length){
            jQuery.ajax({
                method: 'POST',
                cache: false,
                url: "https://users.sussex.ac.uk/mel29/exp_data/save_data_metacog.php",
                data: {
        ...
        function save_data_csv(dataset, data_length){
            jQuery.ajax({
                method: 'POST',
                cache: false,
                url: "https://users.sussex.ac.uk/mel29/exp_data/save_data_metacog_csv.php",
                data: {
    ...
    function initExp() {
        ...
        var num_trial = 5; //168 if testing, must be multiple of 5 as 5 blocks are used
